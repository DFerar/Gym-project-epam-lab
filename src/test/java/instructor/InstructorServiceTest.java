...
class InstructorServiceTest {
    ...
    public void shouldCreateInstructor() {
        ...
        //When
        InstructorEntity result =
            instructorService.createInstructor(gymUserEntity, trainingTypeEntity.getTrainingTypeName());
        //Assert
    ...
    public void shouldUpdateInstructor() {
        ...
        when(instructorRepository.findInstructorEntityByGymUserEntityUserName(any())).thenReturn(instructorEntity);
        ...
        //When
        InstructorEntity result =
            instructorService.updateInstructor(updatedUser, trainingTypeEntity.getTrainingTypeName());
        //Assert
        assertThat(result).isEqualTo(instructorEntity);
    }
    ...
    public void shouldGetInstructorsNotAssignedToCustomerByCustomerUserName() {
        ...
        when(instructorRepository.findUnassignedInstructorsByCustomerUsername(customerUsername)).thenReturn(
            new ArrayList<>());
        //When
        List<InstructorEntity> result =
            instructorService.getInstructorsNotAssignedToCustomerByCustomerUserName(customerUsername);
        //Assert
